...
foreach ($data as $request) {
  ...
  <div class=\"panel panel-default\">
		<div class=\"panel-heading\">".$request->name."
			<span class=\"pull-right clickable panel-toggle panel-collapsed\"><em class=\"fal fa-caret-circle-down\"></em></span></div>
    ...
    <div class=\"row\">
      <div class=\"collapse-container collapse in\" id=\"via-js\">
        ...
        <div class=\"col-xs-8 input-group\">
          <input placeholder=\"URL\" value=\"".$request->url_raw."\" class=\"step-url form-control postier-url urlParamField\" type=\"text\" name=\"\" aria-describedby=\"urlParamsOpen\" style=\"position: relative; top: -10px;\">
